...
\input{sections/00_intro/sysinv/alphamod}
\input{sections/00_intro/sysinv/riskmod}
\input{sections/00_intro/sysinv/txncostmod}
\input{sections/00_intro/sysinv/portconstmod}
\input{sections/00_intro/sysinv/executionmod}
\input{sections/00_intro/sysinv/research}
\input{sections/00_intro/sysinv/modelrisk}