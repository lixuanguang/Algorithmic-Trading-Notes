...
% =============================================================================
% Sources: Harris Ch.4; Johnson Ch.4; Lehalle Ch.1.2; Bacidore Ch.2
% =============================================================================

\subsection{Order Mechanics}
...
% Sources: Harris Ch.4; Johnson Ch.4; Lehalle Ch.1.2
...
\end{enumerate}
Matching gives priority to actual (explicit) orders; implied orders fill residual. Implied orders can chain (second-generation) and extend to more complex spreads, further increasing effective liquidity.
\end{enumerate}
\end{remark}
