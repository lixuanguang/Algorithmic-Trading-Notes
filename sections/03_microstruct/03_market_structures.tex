...
% =============================================================================
% Sources: Harris Ch.5-7; Johnson Ch.2-3; Lehalle Ch.1-2; Bacidore Ch.2, Ch.10
% =============================================================================
...
\begin{remark} \hlt{Inter-Dealer Markets}
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
\item Exchanges: members are specialised dealing houses, broker/dealer firms, large investors who can justify DMA. For more standardised assets.
\item OTC/Inter-Dealer Broker Networks: for assets generally traded OTC.
\end{enumerate}
\end{remark}

\begin{remark} \hlt{Dealer-to-Client Markets}\\
Mix of phone-based trading, single and multi-broker/dealer electronic trading platforms.
\end{remark}

\begin{remark} \hlt{Alternative Markets}
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
\item Electronic Communication Networks (ECNs): uses central limit order books, with continuous auctions.
\item Alternative Trading Systems (ATSs): opaque order-driven dark-pools. Either use standard auction, or negotiated, advertised, or internal crossing mechanisms. Price discovery mechanics is either mid-point price from main market, or full order book based.
\begin{enumerate}[label=\arabic*.]
\setlength{\itemsep}{0pt}
\item Scheduled Crosses: equivalent to scheduled anonymous call auctions
\item Continuous Blind Crosses: trading on completely opaque electronic order book.
\item Negotiated Crosses: continuous search into anonymous bilateral negotiation for both size and price.
\item Advertised Crosses: highlight when liquidity is present (block price range), but size not provided.
\end{enumerate}
\end{enumerate}
\end{remark}
...
% - Dark pool selection
% - Dark aggregators
% Sources: Lehalle Ch.1.4; Johnson Ch.3; Bacidore Ch.2.3, Ch.10.3

Dark pools offer substantial cost reduction by trading in size without significant market impact. Execution not guaranteed, signalling risk remains. Optimal approach often combines crossing with trading algorithms.

\begin{remark} \hlt{Dark Pool Cost Savings} \cite{qsg_2008}\\
Millennium ATS study (Dec 2007--Mar 2008): dark pool execution reduced market impact by 62\%, saving 6.6 bps weighted average.
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
\item Micro-cap: 66\% impact reduction, 21.53 bps/share savings
\item Small-cap: 63\% impact reduction, 13.43 bps/share savings
\item Mid-cap: 59\% impact reduction, 8.08 bps/share savings
\item Large-cap: 62\% impact reduction, 5.18 bps/share savings
\end{enumerate}
Savings consistent across capitalisations; larger bps savings for less liquid stocks.
\end{remark}

\begin{remark} \hlt{Crossing Mechanism Comparison} \cite{domowitz_finkelshteyn_yegerman_2008}\\
ITG study of 20+ million orders comparing periodic crossing, continuous crossing, and liquidity aggregation.
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
\item Cost Savings vs Benchmark (bps): Periodic (POSIT): +4 overall; Continuous (POSIT Now): 0 overall; Dark Pool Algos: $-4$ overall; Peer Universe: $-12$ overall
\item Execution Quality ($<$ 30 min): $\mathbb{P} (\abs{\leq 20 \text{bps cost}})$  periodic $88\%$, continuous $77\%$, liquidity aggregator $61\%$
\item Cost Tail Risk: $\mathbb{P} (> 20 \text{bps cost})$ periodic $4\%$, continuous $10\%$, dark pool algos $20\%$
\item Duration Degradation: periodic crossing profitable up to 1 hour, becomes 6 bps cost after 2.5 hours; other dark pools lose up to 25 bps after 2.5 hours
\end{enumerate}
\end{remark}

\begin{remark} \hlt{Crossing Mechanism Selection}
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
\item Dark pool execution beneficial, but no improvement from dark pool algorithms vs periodic crossing
\item Information Leakage: multi-venue routing increases leakage risk; single venue routing may outperform
\item Periodic crossing often more cost-efficient than dark pool liquidity algorithms
\end{enumerate}
\end{remark}

\subsubsection{Market Fragmentation}
% Consequences of multiple venues
% Sources: Lehalle Ch.1; Harris Ch.26
...
% Sources: Harris Ch.6; Lehalle Ch.2.1
...
% Sources: Harris Ch.7; Johnson Ch.1
