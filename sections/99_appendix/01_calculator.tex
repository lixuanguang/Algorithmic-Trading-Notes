\subsection{Financial Calculator Guide (TI BA Pro)}

\begin{method} Settings calibration
...
\begin{method} Memory management
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
...
\begin{method} Computation Shortcuts
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
\item \hlt{Set up calculator for single variable statistics}: \fbox{\strut $2ND$} \fbox{\strut $8$}, then \fbox{\strut $2ND$} \fbox{\strut ENTER} until $1$-V, then \fbox{\strut $CE|C$}. \\
...
\item \hlt{Covariance and correlation}: \fbox{\strut $2ND$} \fbox{\strut $8$}, then \fbox{\strut $2ND$} \fbox{\strut ENTER} until [LIN], then \fbox{\strut $CE|C$}. \\
Enter data setting and clear the data: \fbox{\strut $2ND$} \fbox{\strut $7$} \fbox{\strut $2ND$} \fbox{\strut $CE|C$}.\\
