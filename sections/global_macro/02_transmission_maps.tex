...
\item \textbf{Government Bonds}: Sovereign debt across the curve ($2$Y, $5$Y, $10$Y, $30$Y). Risk-free rate benchmark.
...
\begin{enumerate}[label=\roman*.]
\setlength{\itemsep}{0pt}
\item \textbf{Treasury}: SHY ($1$--$3$Y), IEF ($7$--$10$Y), TLT ($20+$Y), TBT ($2$x inverse $20+$Y)
