...
\newpage
\input{sections/00_intro/00_overallstruct}

% Global Macro
\newpage
\input{sections/02_global_macro/00_overallstruct}

% Microstructure Trading Section
\newpage
\input{sections/03_microstruct/00_overallstruct}

% Research
\newpage
\input{sections/98_research/overallstruct}   

% Appendix Section
\newpage
\input{sections/99_appendix/00_appindex}
